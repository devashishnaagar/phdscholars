...
<p align="center">
<br><br><br><br><br>
<button class="button" onclick="document.location.href='login_teacher.jsp'">Login as Teachers</button><br>
<br><br><br><br>
<button class="button" onclick="document.location.href='login_student.jsp'">Login as Students</button>
<br><br><br><br><br>
</p>
