...
<h2><u><b>Student Login</b></u></h2>

<div class="container">
  
<form action='login_submit_student.jsp' method='post' name="frm">
    ...
    <table border='0'>
        ...
        <tr style='height: 20px;'>
            <td class="col-75"><input type="text" id="fname" name="roll" placeholder="Roll NO"></td>
        </tr>
        ...
        <tr style='height: 20px;'>
            <td class="col-75">  <input type="text" id="lname" name="pwd" placeholder="Password"></td>
        </tr>
